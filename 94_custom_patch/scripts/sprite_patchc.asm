; sprite_patchc.asm - Add sprites from NHL93 to NHL94 Genesis to a custom ROM
...
;               - Change to use custom data pulled by custom_patch.py from custom ROM
...
SPAList
        incbin data\Custom_Tables\Fight\SPAListFight.bin
FrmSprDataOff
        incbin data\Custom_Tables\Fight\FrmSprDataOffFight.bin
SprData
        incbin data\Custom_Tables\Fight\SprDataFight.bin
HotList
        incbin data\Custom_Tables\Fight\HotlistFight.bin