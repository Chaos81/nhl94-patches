...
;--Add the script to expand to 3MB - uses temp.bin in the temp folder
    include scripts\94_to_3MBc.asm

;--Change name of ROM and serial #
;    include scripts\chg_header.asm         ; not changing this on custom ROM
...
;------ Include sprite_patch.asm ------
    include scripts\sprite_patchc.asm    ; Add updated sprites and animations, move and update tables associated with sprites and animations
