; 94_to_4MBc.asm - Expand an NHL94 ROM to 4MB, patch SRAM access
; Created by chaos 
; Current Version - 1.0
; Version History:
;   Version 0.1 - Initial version
;   Version 1.0 - Official version, update ROM header, modified for custom patch
...
;--Load ROM from rom directory--
	org 0
		incbin temp\temp.bin                 ; Copy temp.bin into new file
